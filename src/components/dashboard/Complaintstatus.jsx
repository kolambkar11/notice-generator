...
const complainStatus =[
    { name: 'Total Complaint', initials: 'TC', members: 16, bgColor: 'bg-yellow-600' },
...
<ul role="list" className="mt-3 grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
        {complainStatus.map((dc) => (
          <li key={dc.name} className="col-span-1 flex rounded-md shadow-sm">
            <div
            ...
            <div className="flex flex-1 items-center justify-between truncate rounded-r-md border-b border-r border-t border-gray-200 bg-white">
              <div className="flex-1 truncate px-4 py-2 text-sm">
                <a href={dc.href} className="font-medium text-gray-900 hover:text-gray-600">
                  {dc.name}
                </a>
